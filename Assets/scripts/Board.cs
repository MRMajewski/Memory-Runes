...
public class Board : MonoBehaviour
{
    ...
    bool CheckIfEnd()
    {
        return Tiles.All(tile => !tile.Active); // zwróć: czy wszystkie obiekty z tablicy Tiles są nieaktywne
    }

    public void CheckPair()//metoda tylko do wywyoływania korutyny

    {
        StartCoroutine(CheckPairCoroutine());
    }

    IEnumerator CheckPairCoroutine() //korutyny nie wywyołuje się z kliknięcia myszą, dlatego mamy osobną metodę do tego
    {
